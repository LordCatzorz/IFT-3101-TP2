...
(hfpp = fibonnaci previous previous),\\
(hfc = current fibonnaci),\\
...
\begin{center}
  \begin{tabular}{|rcl|rcl|}
      ...
      $A$ & $\rightarrow$ & \lstinline[]$c$ $A_1$ & $A_1.hpc$  & $:=$ & \lstinline[]$"c"$\\
          ...
          &               &                       & $A_1.hfp$  & $:=$ & \lstinline[]$if $$A_1.hn$\lstinline[]$ > $$A_1.hfc$\\
          &               &                       &            &      & \lstinline[]$then $$A_1.hfc$\lstinline[]$ else $$A_1.hfp$\\
          &               &                       & $A_1.hfc$  & $:=$ & \lstinline[]$if $$A_1.hn$\lstinline[]$ > $$A_1.hfc$ \\
          &               &                       &            &      & \lstinline[]$then $$A_1.hfp + A_1.hfp2$\lstinline[]$ else $$A_1.hfc$\\
          &               &                       & $A_1.hfp2$ & $:=$ & $A_1.hfp$\\
          &               &                       & $A.ok$     & $:=$ & $A_1.ok$\\
      \hline
