...
\begin{center}
  \begin{tabular}{|rcl|rcl|}
      ...
      \hline
      \hline
      $S$ & $\rightarrow$ & $A$ & $S.ok$ & $:=$ & $(247 + 12 \cdot A.si = 23 \cdot A.si + 7 \cdot A.sk)$\\
      \hline
...
\begin{center}
  \begin{tabular}{|rcl|rcl|}
      ...
      \hline
      \hline
      $S$ & $\rightarrow$ & \lstinline[]$a$ $S_1$  & $S.gen$ & $:=$ & \lstinline[]$"00"$$\cdot S_1.cod$\\
          &               &                        & $S.cod$   & $:=$ & $T.cod$\\
          &               &                        & $S.ok$    & $:=$ & $S.gen = S.cod$\\
      \hline
      $S$ & $\rightarrow$ & \lstinline[]$b$ $S_1$  & $S.gen$ & $:=$ & \lstinline[]$"010"$$\cdot S_1.cod$\\
          &               &                        & $S.cod$   & $:=$ & $T.cod$\\
          &               &                        & $S.ok$    & $:=$ & $S.gen = S.cod$\\
      \hline
      $S$ & $\rightarrow$ & \lstinline[]$c$ $S_1$  & $S.gen$ & $:=$ & \lstinline[]$"001"$$\cdot S_1.cod$\\
          &               &                        & $S.cod$   & $:=$ & $T.cod$\\
          &               &                        & $S.ok$    & $:=$ & $S.gen = S.cod$\\
      \hline
      $S$ & $\rightarrow$ & \lstinline[]$d$ $S_1$  & $S.gen$ & $:=$ & \lstinline[]$"1"$$\cdot S_1.cod$\\
          &               &                        & $S.cod$ & $:=$ & $T.cod$\\
          &               &                        & $S.ok$  & $:=$ & $S.gen = S.cod$\\
      \hline
      $S$ & $\rightarrow$ & \lstinline[]$:$ $T$    & $S.gen$ & $:=$ & \lstinline[]$""$\\
          &               &                        & $S.cod$ & $:=$ & $T.cod$\\
          &               &                        & $S.ok$  & $:=$ & $S.gen = S.cod$\\
      \hline
      $T$ & $\rightarrow$ & \lstinline[]$0$ $T_1$  & $T.cod$ & $:=$ & \lstinline[]$"0"$$\cdot T_1.cod$\\
      \hline
      $T$ & $\rightarrow$ & \lstinline[]$1$ $T_1$  & $T.cod$ & $:=$ & \lstinline[]$"1"$$\cdot T_1.cod$\\
      \hline
      $T$ & $\rightarrow$ & $\epsilon$ & $T.cod$ & $:=$ & \lstinline[]$""$\\
      \hline
  \end{tabular}
\end{center}

Vérification positive avec le mot \lstinline[]$:$ $ \in L_5$
\begin{center}
  \begin{tikzpicture}
    [
...
Vérification négative avec le mot \lstinline[]$a:$ $ \notin L_5$
\begin{center}
  \begin{tikzpicture}
    [
    sibling distance=2em, level distance=30pt]
    ...
    {(\tikzparentnode) -- (\tikzchildnode)}}}
    \Tree 
    [.$S\tbox{ok}{false}\tbox{gen}{"a"}\tbox{cod}{""}$ 
      a
      [.$S\tbox{ok}{true}\tbox{gen}{""}\tbox{cod}{""}$ 
        :
        [.$T\tbox{cod}{""}$
